...
import de.mcreloaded.tools.libary.ChunkLibary;
...
public final class IronHammer extends CustomItem implements Listener {
	...
	public IronHammer() {
		...
		Bukkit.getPluginManager().registerEvents(this, MCReloaded.getPlugin());
	}
	...
	public void onBreak(BlockBreakEvent e) {
		...
		if(isCorrectItem(item)){
			BlockFace face = MCReloaded.getPlugin().USERMANAGER.getProfile(player.getUniqueId()).getLastBlockFace();
